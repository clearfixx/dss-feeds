...
describe(
  ...
  () => {
    it(
      'creates a complete snapshot after a successful provider request',
      async () => {
        const payloadMock =
          createPayloadMock()
        const fetchMock =
        ...
        const result =
          await synchronizeGitHubFeed({
            payload:
              payloadMock as unknown as Payload,
            fetch:
    ...
    it(
      'replaces the existing snapshot in one update',
      async () => {
        ...
        const result =
          await synchronizeGitHubFeed({
            payload:
              payloadMock as unknown as Payload,
            fetch:
              createFetchMock() as typeof globalThis.fetch,
            now,
          })
    ...
    it(
      'does not modify the cache when GitHub fails',
      async () => {
        const payloadMock =
          createPayloadMock()
    ...
    it(
      'skips provider work when nextSyncAt is still in the future',
      async () => {
        const payloadMock =
          createPayloadMock({
            existing: [
    ...
    it(
      'allows forced synchronization before nextSyncAt',
      async () => {
        const payloadMock =
          createPayloadMock({
            existing: [
    ...
    it(
      'skips all provider and cache work when disabled',
      async () => {
        const payloadMock =
          createPayloadMock({
            settings:
    ...
    it(
      'rejects incomplete enabled settings before contacting GitHub',
      async () => {
        const payloadMock =
          createPayloadMock({
            settings:
